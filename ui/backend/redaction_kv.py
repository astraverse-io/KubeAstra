# Vendored from mcp/k8s/redaction.py at 2026-06-22.
# Keep in sync when the MCP-side regexes change (typically only when a new
# secret class is added). Self-contained copy avoids a sys.path dependency on
# the MCP package layout in dockerized deployments.
