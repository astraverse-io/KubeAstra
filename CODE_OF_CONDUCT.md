...
This Code of Conduct applies within all project spaces — GitHub issues, pull requests, discussions, and any other community forums — and also applies when an individual is officially representing the project in public spaces.
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org), version 2.1, widely adopted by open source projects including Kubernetes, CNCF, and thousands of others.
